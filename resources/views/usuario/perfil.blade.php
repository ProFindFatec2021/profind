...
<a href="{{route('usuario.perfil.pedido.index')}}" class="btn btn-success my-2 w-25 d-block mx-auto">Ver pedidos</a>
...
<form action="{{route('usuario.perfil.destroy')}}" method="post">
  @csrf
  @method('delete')
  <button onclick="return confirm('Deseja mesmo deletar sua conta?')" type="submit" class="btn btn-danger my-2 w-25 d-block mx-auto">Deletar perfil</button>
</form>
